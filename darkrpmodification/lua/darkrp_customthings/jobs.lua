...
-- TEAM_CC0 = DarkRP.createJob("Midget Men", {
--    color = Color(184, 184, 184, 255),
--    model = {"models/cktheamazingfrog/player/jawa/jawa.mdl"},
--    description = [[Pog]],
--    weapons = {"rw_sw_e44", "cross_arms_swep", "rw_sw_rps6", "rw_sw_dual_westar35", "weapon_bactainjector", "weapon_squadshield_arm", "realistic_hook"},
--    command = "midget_men",
--    max = 0,
--    salary = 450,
--    admin = 0,
...
-- TEAM_CC0 = DarkRP.createJob("Mandalorian", {
--    color = Color(184, 184, 184, 255),
--    model = {"models/player/fortnite/mandalorian.mdl"},
--    description = [[Wolf's Custom Character]],
--    weapons = {"wos_inventory", "cross_arms_swep", "jet_mk1", "rw_sw_tusken_cycler", "rw_sw_westar35", "weapon_lightsaber_cc_mandalorian", "weapon_bactainjector"},
--    command = "mandalorian",
--    max = 1,
--    salary = 500,
--    admin = 0,
...
-- TEAM_CC0 = DarkRP.createJob("Dark Trooper", {
--    color = Color(184, 184, 184, 255),
--    model = {"models/nada/darktrooper.mdl"},
--    description = [[]],
--    weapons = {"rw_sw_b2rp_rocket", "rw_sw_e11t", "rw_sw_dlt19x", "jet_mk3", "weapon_bactainjector", "jet_mk1"},
--    command = "dark_trooper",
--    max = 0,
--    salary = 450,
--    admin = 0,
--    vote = false,
...
-- TEAM_CC0 = DarkRP.createJob("Imperial Advisor", {
--    color = Color(153, 97, 219, 255),
--     model = {"models/nada/pms/male/black_naval_officer.mdl", "models/nada/pms/male/admiral.mdl", "models/nada/pms/female/admiral.mdl", "models/player/ven/tk_novatrooper_04/tk_novatrooper.mdl", "models/player/bunny/zephyr_fleet/male/male_fleet_grand_admiral.mdl", "models/player/bunny/zephyr_fleet/female/female_fleet_four.mdl", "models/nada/pms/male/presscorps.mdl"},
--    description = [[Cinder's Custom Character - This position is external to the Empire and holds the clearence level of 7, granted by Emperor Palpatine himself, The person who holds this title is to listened to at all times by all imperial personnel, this person can overview any regiment they seem it necessary.]],
--     weapons = {"cross_arms_infront_swep", "rw_sw_e11d", "weapon_lightsaber_royalguard", "rw_sw_dual_rk3", "weapon_cuff_elastic", "alydus_fusioncutter", "sc_tranceiver", "cross_arms_swep"},
--    command = "imperialadvisor",
--    max = 0,
--    salary = 500,
--    admin = 0,
--    vote = false,
...
-- TEAM_CCSTARKILLER = DarkRP.createJob("Starkiller", {
--     color = Color(184, 184, 184),
--     model = {"models/konnie/starwars/starkiller.mdl", "models/konnie/starwars/starkiller_apprentice.mdl", "models/konnie/starwars/starkiller_sithrobe.mdl", "models/konnie/starwars/starkiller_desert.mdl", "models/konnie/starwars/starkiller_jedihunter.mdl"},
--     description = [[
         
--     ]],
--     weapons = {
--         "weapon_lightsaber_cc_starkiller",
--         "rw_sw_defender"
--     },
--     command = "cc_starkiller",
--     max = 1,
--     salary = 500,
--     admin = 0,
--     vote = false,
